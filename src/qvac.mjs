...
export async function decideAction({ plan, transcript, toolResults }) {
  try {
...
{"action":"ask","question":"..."} pide un dato faltante (edad, contexto, duración de las molestias).
...
Nunca inventes precios ni coberturas: los montos los calculan únicamente las herramientas. La explicación no debe incluir cifras ni el símbolo $. El plan de este caso es ${plan}. /no_think` },
