...
function systemPrompt(specialtyIds) {
  ...
  return [
    ...
    '',
    'specialty: el identificador cuyo alcance describa la molestia que el paciente contó.',
    ...
    '',
    'ageYears: la edad en años solo si el paciente la dijo o la implica claramente; un bebé es 0. Si no la dijo, null.',
    'isPregnant: true o false solo si el paciente lo mencionó. Si no lo mencionó, null.',
    'durationDays: los días que lleva la molestia solo si el paciente lo dijo; "desde ayer" es 1 y "desde hoy" es 0. Si no lo dijo, null.',
    '',
